...
useEffect(() => {
  ...
  console.log('🔄 StateGraph mounting/updating');
  ...
  // ✨ NEW: Always check for saved layout in window global
  ...
  setTimeout(checkSavedLayout, 50);
...
}, [graphData, showScreenGroups]); // ✨ ONLY these two dependencies
...
// ✅ Also store helper methods separately if you need them
